We thank the reviewer for the continued engagement. We take the concern about accuracy guarantees seriously and provide both formal analysis and new empirical evidence.
...
**New: Cross-Domain Experiments.** 

...

**Spec-Bench.** On Spec-Bench (96 samples): 2.32× speedup; 100% math accuracy; LLM-as-Judge delta = −0.02 on a 1–5 scale—no measurable degradation.

We will incorporate the formal analysis, cross-domain experiments, and error propagation discussion in the revised manuscript.